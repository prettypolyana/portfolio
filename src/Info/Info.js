...
function Info() {
    return (
        <section className='info'>
            <p className='info__text'><span className='info__text-color'>Hi there!</span> My name is <span className='info__text-color'>Lina</span>, <br /> I am a <span className='info__text-color'>beginner 
